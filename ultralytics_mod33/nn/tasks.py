...
from ultralytics_mod33.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
from ultralytics_mod33.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, emojis, yaml_load
from ultralytics_mod33.utils.checks import check_requirements, check_suffix, check_yaml
from ultralytics_mod33.utils.loss import (
    E2EDetectLoss,
...
from ultralytics_mod33.utils.ops import make_divisible
from ultralytics_mod33.utils.plotting import feature_visualization
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from ultralytics_mod33.models.utils.loss import RTDETRDetectionLoss
...
def torch_safe_load(weight, safe_only=False):
    ...
    """
    from ultralytics_mod33.utils.downloads import attempt_download_asset
