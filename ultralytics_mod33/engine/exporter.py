...
from ultralytics_mod33.cfg import TASK2DATA, get_cfg
from ultralytics_mod33.data import build_dataloader
from ultralytics_mod33.data.dataset import YOLODataset
from ultralytics_mod33.data.utils import check_cls_dataset, check_det_dataset
from ultralytics_mod33.nn.autobackend import check_class_names, default_class_names
from ultralytics_mod33.nn.modules import C2f, Classify, Detect, RTDETRDecoder
from ultralytics_mod33.nn.tasks import DetectionModel, SegmentationModel, WorldModel
...
from ultralytics_mod33.utils.checks import check_imgsz, check_is_path_safe, check_requirements, check_version
from ultralytics_mod33.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from ultralytics_mod33.utils.files import file_size, spaces_in_path
from ultralytics_mod33.utils.ops import Profile
from ultralytics_mod33.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if imx:
            from ultralytics_mod33.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from ultralytics_mod33.utils.tal import make_anchors
