...
def collect_system_info():
    ...
    from ultralytics_mod33.utils import ENVIRONMENT  # scope to avoid circular import
    from ultralytics_mod33.utils.torch_utils import get_cpu_info, get_gpu_info
