...
from ultralytics_mod33.data.utils import polygons2masks, polygons2masks_overlap
from ultralytics_mod33.utils import LOGGER, colorstr
from ultralytics_mod33.utils.checks import check_version
from ultralytics_mod33.utils.instance import Instances
from ultralytics_mod33.utils.metrics import bbox_ioa
from ultralytics_mod33.utils.ops import segment2box, xyxyxyxy2xywhr
from ultralytics_mod33.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class LetterBox:
    ...
    def __call__(self, labels=None, image=None):
        ...
        if shape[::-1] != new_unpad:  # resize
            ...
            img = resize(img, tuple((reversed(new_unpad)))+(img.shape[2],), anti_aliasing=True)
